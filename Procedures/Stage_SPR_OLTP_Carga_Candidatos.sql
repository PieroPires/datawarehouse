...
SELECT A.Cod_Cand, 
	...
	ISNULL(R.MotivoRem_CandREM, 'EM BRANCO') AS MOTIVO_REMOCAO ,
	R.Data_candREM AS DATA_REMOCAO ,
	DATEDIFF(MONTH, A.dtcriacao_cand, R.Data_candREM) AS TEMPO_PERMANENCIA_MESES ,
	DATEDIFF(YEAR, A.dtcriacao_cand, R.Data_candREM) AS TEMPO_PERMANENCIA_ANOS
