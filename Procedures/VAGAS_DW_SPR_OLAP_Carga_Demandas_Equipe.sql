...
FERRAMENTA, SINTOMA, INDICE_SATISFACAO, LABEL,SPRINT, STORY_POINTS, SOLICITANTE, TIPO_ANALISE, DATA_INCLUSAO_NORMALIZADA, TEMPO_MEDIO_ABERTO_GC, TEMPO_MEDIO_ATENDIMENTO_GC, DATA_PRM_CONCLUSAO, FILA)
SELECT	A.ID_DEMANDA ,
		A.NUMERO_DEMANDA ,
		A.NOME_DEMANDA ,
		A.NOME_PROJETO ,
