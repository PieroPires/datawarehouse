...
--SELECT * FROM VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS
	...
	DELETE FROM VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_KARINA WHERE [0] = '' OR [0] IS NULL
	DELETE FROM VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_TATIANE WHERE [0] = '' OR [0] IS NULL
	DELETE FROM VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_DANIELA WHERE [0] = '' OR [0] IS NULL
	DELETE FROM VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_ALLANA WHERE [0] = '' OR [0] IS NULL
