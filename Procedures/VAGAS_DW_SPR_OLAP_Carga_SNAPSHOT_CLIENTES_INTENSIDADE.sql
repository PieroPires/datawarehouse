...
-- Popula a tabela CLIENTES_INTENSIDADE:
EXEC [VAGAS_DW].[SPR_OLAP_CARGA_CLIENTES_INTENSIDADE] ;
...
INSERT INTO [VAGAS_DW].[SNAPSHOT_CLIENTES_INTENSIDADE] (DATA_CARGA,CONTA_CRM,INTENSIDADE,RISCO_RESCISAO,PRINCIPAL_MOTIVO_RISCO,OBS_DET_RISCO)
SELECT	@DATA_CARGA ,
		A.CONTA_CRM ,
		A.INTENSIDADE ,
		A.RISCO_RESCISAO ,
