...
select 'hash' [email], 'id' id/*, 'nome' nome*/, 'data de cadastro' dtCadastro, 'data de atualizacao' dtUltAtualizacao, 'genero' genero, 'estado civil' estadoCivil  
  ...
  , 'candidato sem experiencia' CandidatoSemExperiencia, 'mala direta' MalaDireta_cand, 'data da ultima candidatura' dtUltCandidatura, 'OP' OP  
union all  
select   
...
--WHERE C.cod_cand IN ( SELECT Cod_Cand 
--						FROM [HRH-DATA].DBO.Candidatos 
--						WHERE FezAcessoIrrestrito_Cand = 1
--						AND /*( UltDtAtual_cand >=  '20170501'
--						OR */ CPF_Cand IN ('41234326892','28877271841','31641014814','32724605861') /*)*/ 
--						)
