...
------------------- INICIO CAC --------------------------------------------
	...
	OUTER APPLY ( SELECT COUNT(*) AS QTD_CLIENTES_ATIVOS
				  FROM VAGAS_DW.LTV
				  WHERE DATA_REFERENCIA = A.DATA ) B
	...
	OUTER APPLY ( SELECT TOP 1 SUM(QTD) AS QTD_CLIENTES_NOVOS 
				  FROM #TMP_CLIENTES_NOVOS 
				  WHERE DATA_REFERENCIA = A.DATA) H
...
ALTER TABLE VAGAS_DW.INDICADORES_CONSOLIDADO ALTER COLUMN CHURN_RATE_SUPERA NUMERIC(8,4)
ALTER TABLE VAGAS_DW.INDICADORES_CONSOLIDADO ALTER COLUMN CHURN_RATE_SIMPLIFICA NUMERIC(8,4)
ALTER TABLE VAGAS_DW.INDICADORES_CONSOLIDADO ALTER COLUMN NEW_CUSTOMER_AQUISITION_SUPERA NUMERIC(8,4)
ALTER TABLE VAGAS_DW.INDICADORES_CONSOLIDADO ALTER COLUMN NEW_CUSTOMER_AQUISITION_SIMPLIFICA NUMERIC(8,4)

ALTER TABLE VAGAS_DW.INDICADORES_CONSOLIDADO ALTER COLUMN NET_CUSTOMER_CHURN_RATE_SUPERA NUMERIC(8,4)
ALTER TABLE VAGAS_DW.INDICADORES_CONSOLIDADO ALTER COLUMN NET_CUSTOMER_CHURN_RATE_SIMPLIFICA NUMERIC(8,4)
