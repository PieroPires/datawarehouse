...
SELECT NOME_EQUIPE,MARCO_ESTRATEGICO,CRITERIO_SUCESSO,NOME_PLANILHA,URL_PLANILHA,PERC_ATINGIMENTO_MARCO,@DATA_REFERENCIA
FROM VAGAS_DW.EVOLUCAO_MARCOS_EQUIPES A
WHERE DATA_REFERENCIA <> ( SELECT MAX(DATA_REFERENCIA) FROM VAGAS_DW.EVOLUCAO_MARCOS_EQUIPES )
