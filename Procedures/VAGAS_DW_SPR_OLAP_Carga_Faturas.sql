...
DATA_REFERENCIA,FLAG_PAGO,FLAG_PAGO_INTEGRAL,FLAG_PAGO_EM_ATRASO,DATA_EMISSAO,PRAZO_PAGTO,PRODUTO,CNPJ)
...
DATA_EMISSAO,PRAZO_PAGTO,PRODUTO,CNPJ
FROM VAGAS_DW.TMP_FATURAS
...
DATA_REFERENCIA,FLAG_PAGO,FLAG_PAGO_INTEGRAL,FLAG_PAGO_EM_ATRASO,DATA_EMISSAO,PRAZO_PAGTO,MAX(PRODUTO) AS PRODUTO,CNPJ
...
VALOR,JUROS,VALOR_LIQUIDO,TIPO_ORIGEM,TIPO,SALDO,STATUS_ORIGEM,STATUS,ID_CNAB,DATA_VENCIMENTO_REAL_ORIGINAL,FAIXA_ATRASO,DIAS_ATRASO,
DATA_REFERENCIA,FLAG_PAGO,FLAG_PAGO_INTEGRAL,FLAG_PAGO_EM_ATRASO,DATA_EMISSAO,PRAZO_PAGTO,CNPJ
HAVING COUNT(*) > 1
ORDER BY CLIENTE
