...
DATA_REFERENCIA,FLAG_PAGO,FLAG_PAGO_INTEGRAL,FLAG_PAGO_EM_ATRASO,DATA_EMISSAO,PRAZO_PAGTO,PRODUTO,CNPJ,COD_NATUREZA,NATUREZA,TIPO)
...
DATA_EMISSAO,PRAZO_PAGTO,PRODUTO,REPLACE(TRANSLATE(CNPJ, '.-/','   '),' ','') AS CNPJ,COD_NATUREZA,NATUREZA,TIPO
FROM VAGAS_DW.TMP_FATURAS
