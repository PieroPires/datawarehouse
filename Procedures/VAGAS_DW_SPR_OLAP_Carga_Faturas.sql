...
UPDATE VAGAS_DW.TMP_FATURAS SET TIPO = 'FUTURO'
...
DATA_REFERENCIA,FLAG_PAGO,FLAG_PAGO_INTEGRAL,FLAG_PAGO_EM_ATRASO,DATA_EMISSAO,PRAZO_PAGTO,PRODUTO,CNPJ,COD_NATUREZA,NATUREZA,TIPO,PARCELA,LINK_NFE,STATUS_ATRASO)
...
DATA_EMISSAO,PRAZO_PAGTO,PRODUTO,REPLACE(TRANSLATE(CNPJ, '.-/','   '),' ','') AS CNPJ,COD_NATUREZA,NATUREZA,TIPO,PARCELA,LINK_NFE,STATUS_ATRASO
FROM VAGAS_DW.TMP_FATURAS
...
COD_NATUREZA,NATUREZA, PARCELA,LINK_NFE,STATUS_ATRASO
...
VALOR,JUROS,VALOR_LIQUIDO,TIPO_ORIGEM,TIPO,SALDO,STATUS_ORIGEM,STATUS,ID_CNAB,DATA_VENCIMENTO_REAL_ORIGINAL,FAIXA_ATRASO,DIAS_ATRASO,
DATA_REFERENCIA,FLAG_PAGO,FLAG_PAGO_INTEGRAL,FLAG_PAGO_EM_ATRASO,DATA_EMISSAO,PRAZO_PAGTO,STATUS_INADIMPLENCIA,CNPJ,COD_NATUREZA,NATUREZA,PARCELA,LINK_NFE,STATUS_ATRASO
HAVING COUNT(*) > 1
ORDER BY CLIENTE
