...
, CONCAT(COD_PRODUTO, ' ', ROW_NUMBER() OVER(PARTITION BY CONTA, OPORTUNIDADE, PROPOSTA, PRODUTO ORDER BY PRODUTO, VALORPRODUTO ASC)) AS CONTROLE_OPP_PROD, NULL AS SOMA_PRODUTOS_OPP,NEGOCIACAO_MRR
...
Campanha,POSSUI_CONTA_MEMBRO,DATA_REFERENCIA,INSERT_MANUAL,NEGOCIACAO_MRR)
...
@DATA_REFERENCIA AS DATA_REFERENCIA,INSERT_MANUAL,NEGOCIACAO_MRR FROM VAGAS_DW.OPORTUNIDADES
END