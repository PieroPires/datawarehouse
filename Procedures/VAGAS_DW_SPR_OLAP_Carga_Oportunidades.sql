...
, CONCAT(COD_PRODUTO, ' ', ROW_NUMBER() OVER(PARTITION BY CONTA, OPORTUNIDADE, PROPOSTA, PRODUTO ORDER BY PRODUTO, VALORPRODUTO ASC)) AS CONTROLE_OPP_PROD, NULL
...
Campanha,POSSUI_CONTA_MEMBRO,DATA_REFERENCIA,INSERT_MANUAL)
