...
DELETE STAGE.VAGAS_DW.TMP_INDICADOR_MARCOS_INTRANET 
FROM STAGE.VAGAS_DW.TMP_INDICADOR_MARCOS_INTRANET 
...
DELETE FROM STAGE.VAGAS_DW.TMP_INDICADOR_MARCOS_INTRANET WHERE CICLO IS NULL
...
SELECT DISTINCT 
		CASE WHEN NOME_EQUIPE = 'Comercial Supera' AND CICLO_INICIO < '20171126' THEN 'Comercial' ELSE NOME_EQUIPE END AS NOME_EQUIPE ,
		NUMERO_MARCO,
