...
TRUNCATE TABLE [VAGAS_DW].[VAGAS_DW].[TMP_CREDITOS_CONSUMO]								  
...
INSERT INTO [VAGAS_DW].[VAGAS_DW].[TMP_CREDITOS_CONSUMO](DATA_REFERENCIA, COD_CLI, CLIENTE_VAGAS, DATA_CREDITO_CONSUMO, CONTAID, TIPO_CONSUMO, CREDITOS_CONSUMO)
