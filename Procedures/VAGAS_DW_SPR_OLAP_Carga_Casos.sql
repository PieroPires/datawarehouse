...
DECLARE	@DATA_REFERENCIA_INICIAL SMALLDATETIME ,
	...
	SELECT ID_CASO ,
		...
		--DATEDIFF(HOUR,A.DATA_INCLUSAO,  CASE 
		--								WHEN ISNULL(A.DATA_FECHAMENTO, A.DATA_MODIFICACAO) < A.DATA_MODIFICACAO 
		--									THEN A.DATA_MODIFICACAO 
		--								ELSE ISNULL(A.DATA_FECHAMENTO, A.DATA_MODIFICACAO) 
		--END) AS TME			
		DATEDIFF(HOUR, DATA_INCLUSAO_NORMALIZADA, DATA_PRM_ACAO) AS TME -- INCLUSO EM 30/11/2016.
...
-- Inserir novos casos 
INSERT INTO VAGAS_DW.CASOS (ID_CASO,NUMERO_CASO,CONTA,FILA_ATENDIMENTO,[STATUS],PRIORIDADE,CRITICIDADE,ORIGEM,TIPO,SUB_TIPO,DATA_INICIO_ATENDIMENTO,DATA_FECHAMENTO,	DATA_INCLUSAO,DATA_MODIFICACAO,USUARIO_RESPONSAVEL,ORIGEM_SUPORTE,DATA_PRM_ACAO,DATA_INCLUSAO_NORMALIZADA,TME,TMR)
SELECT	ID_CASO,NUMERO_CASO,CONTA,FILA_ATENDIMENTO,[STATUS],PRIORIDADE,CRITICIDADE,ORIGEM,TIPO,SUB_TIPO,DATA_INICIO_ATENDIMENTO,DATA_FECHAMENTO,	DATA_INCLUSAO,DATA_MODIFICACAO,USUARIO_RESPONSAVEL,ORIGEM_SUPORTE,DATA_PRM_ACAO,DATA_INCLUSAO_NORMALIZADA,TME,TMR
FROM #TMR_CASOS