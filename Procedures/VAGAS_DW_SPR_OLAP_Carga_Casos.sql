...
SELECT ID_CASO,NUMERO_CASO,CONTA,FILA_ATENDIMENTO,STATUS,PRIORIDADE,CRITICIDADE,ORIGEM,TIPO,SUB_TIPO,DATA_INICIO_ATENDIMENTO,
	   ...
	   CASE WHEN DATEPART(WEEKDAY,DATA_INCLUSAO_NORMALIZADA) = 7 -- SÁBADO
			...
			ELSE DATA_INCLUSAO_NORMALIZADA END AS DATA_INCLUSAO_NORMALIZADA, CONTA_ID, UPPER(IIF(MERCADO IS NULL OR MERCADO = '', 'EM BRANCO', MERCADO)) AS MERCADO,TIPO_CLIENTE,MOTIVO_CONTATO,NOME_CONTATO_EMAIL,CONTATO_ADM_PRINCIPAL
...
FROM 
	...
	SELECT ID_CASO,NUMERO_CASO,CONTA,FILA_ATENDIMENTO,STATUS,PRIORIDADE,CRITICIDADE,ORIGEM,TIPO,SUB_TIPO,DATA_INICIO_ATENDIMENTO,
			...
			CASE WHEN (DATEPART(HOUR,DATA_INCLUSAO) >= 19 AND DATEPART(MINUTE, DATA_INCLUSAO) > 0) OR (DATEPART(HOUR, DATA_INCLUSAO) > 19)
							...
							ELSE DATA_INCLUSAO END AS DATA_INCLUSAO_NORMALIZADA, CONTA_ID, MERCADO, EMAIL_CONTATO,TIPO_CLIENTE,MOTIVO_CONTATO,NOME_CONTATO_EMAIL,CONTATO_ADM_PRINCIPAL
...
-- Inserir novos casos 
INSERT INTO VAGAS_DW.CASOS (ID_CASO,NUMERO_CASO,CONTA,FILA_ATENDIMENTO,[STATUS],PRIORIDADE,CRITICIDADE,ORIGEM,TIPO,SUB_TIPO,DATA_INICIO_ATENDIMENTO,DATA_FECHAMENTO,  DATA_INCLUSAO,DATA_MODIFICACAO,USUARIO_RESPONSAVEL,ORIGEM_SUPORTE,DATA_PRM_ACAO,DATA_INCLUSAO_NORMALIZADA,TME, TMS, CONTA_ID, MERCADO, EMAIL_CONTATO,TIPO_CLIENTE,MOTIVO_CONTATO,NOME_CONTATO_EMAIL,CONTATO_ADM_PRINCIPAL) 
SELECT  ID_CASO,NUMERO_CASO,CONTA,FILA_ATENDIMENTO,[STATUS],PRIORIDADE,CRITICIDADE,ORIGEM,TIPO,SUB_TIPO,DATA_INICIO_ATENDIMENTO,DATA_FECHAMENTO,  DATA_INCLUSAO,DATA_MODIFICACAO,USUARIO_RESPONSAVEL,ORIGEM_SUPORTE,DATA_PRM_ACAO,DATA_INCLUSAO_NORMALIZADA,TME, TMS, CONTA_ID, MERCADO, EMAIL_CONTATO,TIPO_CLIENTE,MOTIVO_CONTATO,NOME_CONTATO_EMAIL,CONTATO_ADM_PRINCIPAL 
FROM #TMR_CASOS
