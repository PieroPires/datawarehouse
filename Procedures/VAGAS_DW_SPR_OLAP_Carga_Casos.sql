...
GROUP BY
	...
	SELECT ID_CASO ,
		...
		DATA_PRM_ACAO ,
		DATA_INCLUSAO_NORMALIZADA , 
		CASE WHEN (ORIGEM_SUPORTE = 'E-mail' AND (DATA_PRM_ACAO < DATA_INCLUSAO_NORMALIZADA)) THEN 0 ELSE B.DIFERENCA_HORAS END AS TME ,
		CASE WHEN (A.STATUS IN ('fechado', 'fechado_sem_resposta') AND A.FILA_ATENDIMENTO = 'suporte_empresas' AND ISNULL(A.DATA_FECHAMENTO, A.DATA_MODIFICACAO) < A.DATA_INCLUSAO_NORMALIZADA) THEN 0 ELSE C.DIFERENCA_HORAS END AS TMS
	INTO	#TMR_CASOS
