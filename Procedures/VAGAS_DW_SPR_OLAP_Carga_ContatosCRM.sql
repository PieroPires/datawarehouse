...
INSERT INTO [VAGAS_DW].[VAGAS_DW].[CONTATOS_CRM] (COD_CONTATO, NOME, SOBRENOME, DATA_INCLUSAO, DATA_MODIFICACAO, CARGO, DEPARTAMENTO, TELEFONE_CELULAR, TELEFONE_CONTATO, TELEFONE_OUTRO, RUA, CIDADE, ESTADO, PAÍS, EMAIL, CLIENTE_VAGAS, CONTA_CRM, COD_CONTA_CRM, TIPO_CLIENTE_MANUT, TIPO_CLIENTE, EX_CLIENTE)
