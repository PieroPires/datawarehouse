...
TRUNCATE TABLE [VAGAS_DW].[VAGAS_DW].[TMP_CREDITOS_LANC] 
...
INSERT INTO [VAGAS_DW].[VAGAS_DW].[TMP_CREDITOS_LANC](DATA_REFERENCIA, COD_CLI, CLIENTE_VAGAS, DATA_COMPRA, CONTAID, CREDITOS_COMPRA, TIPO_LANCAMENTO_COMPRA, TIPO_COMPRA, CODIGO_COMPRA)
