...
SELECT A.Cod_Vaga VAGAS_Cod_Vaga,
	...
	A.DTPRIMINICIOWEB_VAGA AS DATA_PUBLICACAO_SOURCE,
	CONVERT(DATETIME,CONVERT(VARCHAR,A.DTPRIMINICIOWEB_VAGA ,112)) AS DATA_PUBLICACAO,
	CASE ISNULL(aceitaCandOutroCargo_Vaga, 0) WHEN 1 THEN 'SIM' ELSE 'NÃO' END AS ACEITA_CAND_OUTRO_CARGO,
