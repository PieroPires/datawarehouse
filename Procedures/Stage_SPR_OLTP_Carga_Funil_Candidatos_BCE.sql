...
TRUNCATE TABLE [VAGAS_DW].[VAGAS_DW].[TMP_FUNIL_CANDIDATOS_BCE]
...
INSERT INTO [VAGAS_DW].[VAGAS_DW].[TMP_FUNIL_CANDIDATOS_BCE] (COD_CAND, DATA_CADASTRO, TIPO_CADASTRO, CURRICULO_NOVO, NOME, FOTO, DADOS_PESSOAIS, ENDERECO, CONTATO, LINKS_REDES_SOCIAIS, OBJETIVO, AREA_NIVEL_OBJETIVO, PRETENSAO_SALARIAL, REGIAO_INTERESSE, RESUMO_QUALIFIC, NIVEL_ESCOLARIDADE, EXPERIENCIA_PROFISSIONAL, IDIOMA, ULTIMO_SALARIO, INF_COMPLEMENTARES)
SELECT	A.COD_CAND ,
		A.DATA_CADASTRO ,
