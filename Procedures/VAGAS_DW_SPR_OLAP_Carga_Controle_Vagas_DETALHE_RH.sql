...
SET NOCOUNT ON
	...
	SELECT UPPER([0]) AS NOME_VAGA,
		   ...
		   CASE WHEN RTRIM(LTRIM(REPLACE(REPLACE(REPLACE([12],'v',''),CHAR(13),''),CHAR(10),''))) = '' 
				THEN NULL 
				ELSE RTRIM(LTRIM(REPLACE(REPLACE(REPLACE([12],'v',''),CHAR(13),''),CHAR(10),''))) END AS COD_VAGA,
		   CASE WHEN CHARINDEX('/',[13]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([13],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([13],1,CHARINDEX('/',[13])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([13],CHARINDEX('/',[13])+1,2)),'/','')),2)) -- DIA
			    ELSE NULL END AS DATA_DESLIGAMENTO_ANTERIOR,
		   CASE WHEN CHARINDEX('/',[14]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([14],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([14],1,CHARINDEX('/',[14])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([14],CHARINDEX('/',[14])+1,2)),'/','')),2)) -- DIA
			    ELSE NULL END  AS DATA_RECEBIMENTO_REQUISICAO,
		   CASE WHEN CHARINDEX('/',[15]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([15],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([15],1,CHARINDEX('/',[15])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([15],CHARINDEX('/',[15])+1,2)),'/','')),2)) -- DIA
			    ELSE NULL END AS DATA_DIVULGACAO,
		   CASE WHEN CHARINDEX('/',[16]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([16],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([16],1,CHARINDEX('/',[16])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([16],CHARINDEX('/',[16])+1,2)),'/','')),2)) -- DIA
			    ELSE NULL END AS DATA_SUSPENSAO,
		   CASE WHEN CHARINDEX('/',[17]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([17],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([17],1,CHARINDEX('/',[17])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([17],CHARINDEX('/',[17])+1,2)),'/','')),2)) -- DIA
			    ELSE NULL END AS DATA_REABERTURA,
		   CASE WHEN CHARINDEX('/',[18]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([18],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([18],1,CHARINDEX('/',[18])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([18],CHARINDEX('/',[18])+1,2)),'/','')),2)) -- DIA
			    ELSE NULL END AS DATA_FORUM,
		   CASE WHEN CHARINDEX('/',[19]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([19],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([19],1,CHARINDEX('/',[19])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([19],CHARINDEX('/',[19])+1,2)),'/','')),2)) -- DIA
			    ELSE NULL END AS DATA_APRESENTACAO_PROPOSTA,
		   CASE WHEN CHARINDEX('/',[20]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([20],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([20],1,CHARINDEX('/',[20])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([20],CHARINDEX('/',[20])+1,2)),'/','')),2)) -- DIA
			    ELSE NULL END AS DATA_ACEITE_PROPOSTA,
		   CASE WHEN CHARINDEX('/',[21]) > 0 THEN CONVERT(SMALLDATETIME,RIGHT([21],4) + -- ANO
											RIGHT('00' + CONVERT(VARCHAR,SUBSTRING([21],1,CHARINDEX('/',[21])-1)),2) + -- MES
											RIGHT('00' + CONVERT(VARCHAR,REPLACE(CONVERT(VARCHAR,SUBSTRING([21],CHARINDEX('/',[21])+1,2)),'/','')),2)) -- DIA
