...
SET NOCOUNT ON
	...
	TRUNCATE TABLE STAGE.VAGAS_DW.TMP_CONTROLE_VAGAS_DETALHE_RH
	...
	BEGIN 
		SET @MSG = 'ERRO ocorrido na importação dos dados no ID_CONTROLE_SPREADSHEET : 209' 
		RAISERROR(@MSG , 16, 1) 
	END
	...
	FROM STAGE.VAGAS_DW.TMP_CONTROLE_VAGAS_DETALHE_RH
	WHERE [index] > 0	
