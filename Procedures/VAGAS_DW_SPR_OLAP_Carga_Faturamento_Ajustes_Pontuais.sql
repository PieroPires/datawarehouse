...
-- Alteração solicitada pelo Antony (Financeiro) em 26/11/2018:
UPDATE	[VAGAS_DW].[FATURAMENTO]
SET		PRODUTO = 'VAGAS PONTUAL' ,
		GRUPO_I = 'VAGAS' ,
		GRUPO_II = 'PONTUAL'
FROM	[VAGAS_DW].[FATURAMENTO] AS A
WHERE	A.NUM_PEDIDO = '065812' ;

-- Alteração solicitada pelo Antony (Financeiro) em 17/12/2018:
UPDATE	[VAGAS_DW].[FATURAMENTO]
SET		PRODUTO = 'VAGAS RECRUTADOR ANUID' ,
		GRUPO_I = 'VAGAS' ,
		GRUPO_II = 'RECRUTADOR'
FROM	[VAGAS_DW].[FATURAMENTO] AS A
WHERE	A.NUM_PEDIDO = '070187' ;

-- Alteração solicitada pelo Antony (Financeiro) 31/01/2019: 
UPDATE	[VAGAS_DW].[FATURAMENTO] 
