...
SET NOCOUNT ON
	...
	TRUNCATE TABLE STAGE.VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_TALITA 
...
--SELECT * FROM STAGE.VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS
	...
	WHERE NOME_CONTROLE = 'SOLUÇÕES PERSONALIZADAS - CONSULTORIAS' 
	...
	DELETE FROM STAGE.VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_TALITA WHERE [0] = '' OR [0] IS NULL
	DELETE FROM STAGE.VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_MICHELE WHERE [0] = '' OR [0] IS NULL
	...
	SELECT [0] AS RESPONSAVEL_PROJETO,
		   ...
		   0 AS FLAG_DEMANDA
	FROM STAGE.VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_TALITA
	WHERE [index] <> 0
	...
	INSERT INTO STAGE.VAGAS_DW.TMP_DEMANDAS_SOLUCOES_PERSONALIZADAS_DEMANDAS_EQUIPE (RESPONSAVEL_PROJETO,DATA_RECEBIMENTO,COD_DEMANDA,CLIENTE,CATEGORIA,
																			   ...
																			   FLAG_DEMANDA,TEMPO_GASTO_DSM,VALOR_HORA,VALOR_ADICIONAL,VALOR_PROPOSTA,TEMPO_ORCADO)
	...
	SELECT CASE WHEN COD_DEMANDA = '' THEN 999999
		   ...
		   VALOR_ADICIONAL,
		   VALOR_PROPOSTA,
		   ISNULL((A.TEMPO_GASTO * A.VALOR_HORA),0) + -- VALOR SOLUÇÕES PERSONALIZADAS
