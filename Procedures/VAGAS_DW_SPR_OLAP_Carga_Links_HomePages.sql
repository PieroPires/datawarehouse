...
-- LIMPAR TABELA FATO:
TRUNCATE TABLE [VAGAS_DW].[LINKS_HOMEPAGES] ;


-- Carga dos dados na estrutura OLAP:
INSERT INTO [VAGAS_DW].[LINKS_HOMEPAGES] (ID_CONTA, CONTA, ID_LINK, NOME_LINK, STATUS_LINK, CATEGORIA_LINK, DATA_CRIACAO_LINK, DATA_MODIFICACAO_LINK, QTD_TRANSICOES_LINK, DATA_ULT_TRANSICAO_STATUS, QTD_STATUS_ALTERACAO, DATA_ULT_ALTERACAO_STATUS, QTD_DIAS_APROVACAO, PROPRIETARIO, DATA_SOLICITACAO, MERCADO)
...
FROM	[STAGE].[VAGAS_DW].[TMP_LINKS_HOMEPAGES] ;