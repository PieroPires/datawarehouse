...
@DIRETORIO_CSV VARCHAR(200) = 'Z:\Scripts\TMP\LOG_IIS_RELATORIOS\' -- DIRETÓRIO DE SAÍDA DO ARQUIVO FORMATADO .CSV
...
TRUNCATE TABLE VAGAS_DW.TMP_AUDITORIA_RELATORIOS 
TRUNCATE TABLE VAGAS_DW.TMP_LOG_IIS
...
DELETE FROM #TMP_ARQUIVOS_LOG WHERE DATA_ARQUIVO < @DT_INICIO OR DATA_ARQUIVO > @DT_FIM
	...
	ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] DROP COLUMN ID_GRUPO 
	ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] DROP COLUMN ID
	ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] DROP COLUMN ACCESS_TOKEN 
	ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] DROP COLUMN SEGMENTACAO
...
BEGIN
	...
	--SELECT * FROM VAGAS_DW.TMP_LOG_IIS
	...
	SET @CMD = 'BULK INSERT [VAGAS_DW].[TMP_LOG_IIS] 
	...
	ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] ADD ID INT IDENTITY 
	ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] ADD ID_GRUPO INT
	ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] ADD ACCESS_TOKEN VARCHAR(50)
	ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] ADD SEGMENTACAO VARCHAR(50)
	...
	FROM [VAGAS_DW].[TMP_LOG_IIS] A
	OUTER APPLY ( SELECT TOP 1 * FROM [VAGAS_DW].[TMP_LOG_IIS] 
	...
	UPDATE [VAGAS_DW].[TMP_LOG_IIS] SET SEGMENTACAO = B.SEGMENTACAO 
	FROM [VAGAS_DW].[TMP_LOG_IIS] A
	...
	INSERT INTO VAGAS_DW.TMP_AUDITORIA_RELATORIOS 	
	SELECT  DISTINCT 
	...
	DELETE FROM VAGAS_DW.TMP_AUDITORIA_RELATORIOS WHERE FILE_ID = 'contents----' OR FILE_ID LIKE '%children%'

	UPDATE VAGAS_DW.TMP_AUDITORIA_RELATORIOS SET NOME_RELATORIO = LeafName,
	...
	FROM VAGAS_DW.TMP_AUDITORIA_RELATORIOS A
...
DELETE VAGAS_DW.TMP_AUDITORIA_RELATORIOS
FROM VAGAS_DW.TMP_AUDITORIA_RELATORIOS A
OUTER APPLY ( SELECT AVG(DURACAO_SEGUNDOS) AS MEDIA_DURACAO
			  FROM VAGAS_DW.TMP_AUDITORIA_RELATORIOS 
...
CREATE TABLE [VAGAS_DW].[TMP_LOG_IIS](
	[date] [varchar](200) COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[time] [varchar](100)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[s-ip] [varchar](100)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[cs-method] [varchar](50)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[cs-uri-stem] [varchar](500) COLLATE SQL_Latin1_General_CP1_CI_AI  NULL,
	[cs-uri-query] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[s-port] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[cs-username] [varchar](200)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[c-ip] [varchar](100)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[cs(User-Agent)] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[cs(Cookie)] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[cs(Referer)] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[cs-host] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[sc-status] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[sc-substatus] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[sc-win32-status] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	[time-taken] [varchar](max)  COLLATE SQL_Latin1_General_CP1_CI_AI NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]

ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] ADD ID INT IDENTITY 
ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] ADD ID_GRUPO INT
ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] ADD ACCESS_TOKEN VARCHAR(50)  COLLATE SQL_Latin1_General_CP1_CI_AI 
ALTER TABLE [VAGAS_DW].[TMP_LOG_IIS] ADD SEGMENTACAO VARCHAR(50)  COLLATE SQL_Latin1_General_CP1_CI_AI 
