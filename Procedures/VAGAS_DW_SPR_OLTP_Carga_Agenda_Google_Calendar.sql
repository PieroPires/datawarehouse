...
@ID_AGENDA VARCHAR(150), -- IDENTIFICAÇÃO ÚNICA DA AGENDA (VER NAS CONFIGURAÇÕES DA AGENDA)
@QUANTIDADE_REGISTROS INT = 20, -- QUANTIDADE MÁXIMA DE REGISTROS QUE SERÃO EXIBIDOS A PARTIR DA DATA CONSIDERADA
...
SET @CMD = 'set PYTHONIOENCODING=cp1252 & C:\Python27\python M:\Projetos\Scripts_Python\Google_Calendar\Importacao_Google_Calendar.py ' + 
