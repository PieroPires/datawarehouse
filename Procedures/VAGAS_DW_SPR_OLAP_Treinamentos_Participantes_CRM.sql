...
INSERT INTO [VAGAS_DW].[TREINAMENTOS_PARTICIPANTES_CRM] (ID_PARTICIPANTE, DATA_CRIACAO, DATA_MODIFICACAO, USUARIO_CRIOU, USUARIO_MODIFICOU, DESCRICAO, STATUS_PARTICIPANTE, CONTATO, NOME_TREINAMENTO, CONTA, ID_TREINAMENTO) 
