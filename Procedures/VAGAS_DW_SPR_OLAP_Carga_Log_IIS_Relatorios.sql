...
DELETE VAGAS_DW.VAGAS_DW.AUDITORIA_RELATORIOS
FROM VAGAS_DW.VAGAS_DW.AUDITORIA_RELATORIOS A
WHERE EXISTS ( SELECT 1 FROM VAGAS_DW.VAGAS_DW.TMP_AUDITORIA_RELATORIOS
				WHERE NOME_ARQUIVO = A.NOME_ARQUIVO )

-- GRAVAR DADOS NA TABELA FATO
INSERT INTO VAGAS_DW.VAGAS_DW.AUDITORIA_RELATORIOS
SELECT * FROM VAGAS_DW.VAGAS_DW.TMP_AUDITORIA_RELATORIOS
