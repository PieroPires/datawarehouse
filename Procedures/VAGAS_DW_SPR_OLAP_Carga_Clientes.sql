...
-- MARCAR EX CLIENTES QUE TINHAM PRODUTO RECRUTADOR
UPDATE VAGAS_DW.TMP_CLIENTES SET CONTEM_RECRUTADOR = 1,
								 VALOR_RECRUTADOR = B.ValorProdutoFINAL,
								 --CLIENTE_CRM = B.CONTA,
								 PERFIL_CRM = B.PERFIL,
...
-- MARCANDO QUEM NÃO TEM RECRUTADOR
UPDATE VAGAS_DW.TMP_CLIENTES SET CONTEM_RECRUTADOR = 0
WHERE CONTEM_RECRUTADOR IS NULL
