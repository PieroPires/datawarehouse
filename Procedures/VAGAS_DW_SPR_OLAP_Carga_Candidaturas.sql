...
SELECT @COD_HISTCAND = MIN(COD_HISTCAND) FROM VAGAS_DW.TMP_CANDIDATURAS
...
-- CARREGAR CUBO
INSERT INTO VAGAS_DW.CANDIDATURAS (Cod_histCand,CodCand_HistCand,CodVaga_HistCand,DATA_CANDIDATURA,CPF)
